...
class TestSearchAssetByStatusOrTechnicalSpecs(unittest.TestCase):

    def test_search_asset_by_technical_specs_returns_empty_list(self):
        items = [
            {
                "id": 2,
    ...
    def test_search_asset_by_technical_specs_returns_nonempty_list(self):
        items = [
            {
                "id": 2,
                "serial_no": "C02ZL5NRMD6Q",
        ...
        result = search_asset_by_technical_specs(items, search_tokens)
        assert result is not None, 'expected not null result'
        assert len(result) == 1, f'{search_tokens} must one-element list'
    ...
    def test_search_asset_by_status_pendingreturn_returns_empty_list(self):
        items = []
        result = search_asset_by_status(items)
        assert result is not None, 'expected not null result'
        assert len(result) == 0, 'expected an empty list'

    def test_search_asset_by_status_none_returns_all(self):
        items = [
            {
                "id": 2,
                "serial_no": "C02ZL5NRMD6Q",
    ...
    def test_search_asset_by_status_pendingreturn(self):
        items = [
            {
                "id": 2,
                "serial_no": "C02ZL5NRMD6Q",
